...
#include <zebroscrimmage/plugins/sensor/MyOpenAISensor/MyOpenAISensor.h>
...
REGISTER_PLUGIN(scrimmage::Sensor,
                scrimmage::sensor::MyOpenAISensor,
                MyOpenAISensor_plugin)

namespace scrimmage {
namespace sensor {

MyOpenAISensor::MyOpenAISensor() {
}
