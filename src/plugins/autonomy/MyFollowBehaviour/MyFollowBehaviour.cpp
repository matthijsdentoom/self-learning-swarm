...
#include <zebroscrimmage/plugins/autonomy/MyFollowBehaviour/MyFollowBehaviour.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::MyFollowBehaviour,
                MyFollowBehaviour_plugin)

namespace scrimmage {
namespace autonomy {

void MyFollowBehaviour::init(std::map<std::string, std::string> &params) {
...
bool MyFollowBehaviour::step_autonomy(double t, double dt) {
